...
def main():
    ...
    epoch = config['MLP_model']['epoch']
    lr = config['MLP_model']['lr']
    ...
    train_dataset = MRI_dataset(subj, data_type, brain_type, vis_processors, 
    txt_processors, data_dir, csv_file_path)

    train_loader, eval_loader, test_loader = train_test_split(subj01_train_dataset, batch_size)
